...
import 'package:darl_dispatch/Utils/bol_picker_manager.dart';
...
class AdminLoadDeliveredDetails extends StatefulWidget {
  const AdminLoadDeliveredDetails({Key? key}) : super(key: key);

  @override
  _AdminLoadDeliveredDetailsState createState() => _AdminLoadDeliveredDetailsState();
}

class _AdminLoadDeliveredDetailsState extends State<AdminLoadDeliveredDetails> {
