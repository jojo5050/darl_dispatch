...
class AdminRegisteredWithPDLoadsPreview extends StatefulWidget {
  const AdminRegisteredWithPDLoadsPreview({Key? key}) : super(key: key);

  @override
  _AdminRegisteredWithPDLoadsPreviewState createState() => _AdminRegisteredWithPDLoadsPreviewState();
}

class _AdminRegisteredWithPDLoadsPreviewState extends State<AdminRegisteredWithPDLoadsPreview> {
                                              ...
                                              PopupMenuButton(
                                                  ...
                                                  onSelected: (value){
                                                    switch (value){
                                                      ...
                                                      break;
                                                      case 2: getIDandPushToEdit(index);
                                                      break;
                                                      case 3: getIdMoveToAssign(index);
                                                      break;
                                                      case 4:  getIdNavigate(index);
                                                      break;
                                                      case 5:  navigateToAddPickDrop(index);
                                                      break;
                                                      case 6:  showPopup(index);
                                                      break;
                                                    }
    ...
    try{
      ...
      if(response != null && response.statusCode == 200){
        ...
        setState(() {
          ...
          => element["totalPickups"] != pickStatus).toList();
        });
  ...
  void getIDandPushToEdit(int index) {
