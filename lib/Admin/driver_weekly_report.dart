...
class DriverWeeklyReports extends StatefulWidget {
  const DriverWeeklyReports({Key? key}) : super(key: key);

  @override
  State<DriverWeeklyReports> createState() => _DriverWeeklyReportsState();
}

class _DriverWeeklyReportsState extends State<DriverWeeklyReports> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Driver Weekly PayRoll",
  ...
  void getDriverReport() async {
    final AuthRepo authRepo = AuthRepo();
    try{
      Response? response = await authRepo.driverPayroll();
