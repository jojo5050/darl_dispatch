...
class StaffDueForPayment extends StatefulWidget {
  const StaffDueForPayment({Key? key}) : super(key: key);

  @override
  State<StaffDueForPayment> createState() => _StaffDueForPaymentState();
}

class _StaffDueForPaymentState extends State<StaffDueForPayment> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Staffs Due For Payment",
