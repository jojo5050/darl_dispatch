...
class ActiveDrivers extends StatefulWidget {
  const ActiveDrivers({Key? key}) : super(key: key);

  @override
  State<ActiveDrivers> createState() => _ActiveDriversState();
}

class _ActiveDriversState extends State<ActiveDrivers> {
                            ...
                            children: [
                                    ...
                                    Column(crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        ...
                                        Container(
                                          constraints: BoxConstraints(maxWidth: 250),
                                          child: Text("${listOfActiveDrivers![index]["tel"]}",
                                            overflow: TextOverflow.ellipsis,
                                        ...
                                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: Text(
                                                "${listOfActiveDrivers![index]["rateConfirmationID"]}",
                                                overflow: TextOverflow.ellipsis,
                                                style: TextStyle(
                                                    color: Colors.white,
                                                    fontSize: 18.sp,
                                        ...
                                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            ...
                                            Container(
                                              constraints: BoxConstraints(maxWidth: 200),
                                              child: Text(
                                                "${listOfActiveDrivers![index]["totalLoadPicked" ?? ""]}",
                                                overflow: TextOverflow.ellipsis,
                                                style: TextStyle(
                                                    color: Colors.white,
                                                    fontSize: 15,
                                        ...
                                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            ...
                                            Container(
                                              constraints: BoxConstraints(maxWidth: 200),
                                              child: Text(
                                                "${listOfActiveDrivers![index]["totalLoadDropped" ?? ""]}",
                                                overflow: TextOverflow.ellipsis,
