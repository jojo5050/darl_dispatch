...
class DrLoadsAssignedPreview extends StatefulWidget {
  const DrLoadsAssignedPreview({Key? key}) : super(key: key);

  @override
  _DrLoadsAssignedPreviewState createState() => _DrLoadsAssignedPreviewState();
}

class _DrLoadsAssignedPreviewState extends State<DrLoadsAssignedPreview> {
