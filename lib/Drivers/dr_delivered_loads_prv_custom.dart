...
class DrLoadDeliveredPreviewCustom extends StatefulWidget {
  const DrLoadDeliveredPreviewCustom({Key? key}) : super(key: key);

  @override
  _DrLoadDeliveredPreviewCustomState createState() => _DrLoadDeliveredPreviewCustomState();
}

class _DrLoadDeliveredPreviewCustomState extends State<DrLoadDeliveredPreviewCustom> {
