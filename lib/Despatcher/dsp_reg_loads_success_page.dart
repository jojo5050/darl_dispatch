...
class DspRegLoadsSuccessPage extends StatefulWidget {
  const DspRegLoadsSuccessPage({Key? key}) : super(key: key);

  @override
  State<DspRegLoadsSuccessPage> createState() => _DspRegLoadsSuccessPageState();
}

class _DspRegLoadsSuccessPageState extends State<DspRegLoadsSuccessPage> {
  @override
