...
class DspLoadsAssignedPreview extends StatefulWidget {
  const DspLoadsAssignedPreview({Key? key}) : super(key: key);

  @override
  _DspLoadsAssignedPreviewState createState() => _DspLoadsAssignedPreviewState();
}

class _DspLoadsAssignedPreviewState extends State<DspLoadsAssignedPreview> {
  ...
  void getAllAsignedLoads() async {
    var dspId = await LocalStorage().fetch("idKey");
